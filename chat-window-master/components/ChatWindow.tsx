...
class ChatWindow extends React.Component<Props, State> {
  ...
  render() {
    const {
      ...
      newMessagePlaceholder = 'Write you message here...',
      ...
      >
        <Box sx={{bg: 'primary', position: 'relative'}}>
          <Box pt={3} pb={showAgentAvailability ? 12 : 16} px={20}>
            ...
            >
              Meet the hospitality AI experts!
            </Heading>
            <Text sx={{color: 'offset'}}>
              Product Support Assistant: Ask me anything related to inhotel.io
              in your language.
            </Text>
          </Box>
